...
import com.ISA2020.back.security.RestAuthenticateEntryPoint;
import com.ISA2020.back.security.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private UserCustomDetailServiceImpl jwtUserDetailsService;
	// Handler za vracanje 401 kada klijent sa neodogovarajucim korisnickim imenom i lozinkom pokusa da pristupi resursu
	@Autowired
	private RestAuthenticateEntryPoint restAuthenticationEntryPoint;
	...
	// Definisemo prava pristupa odredjenim URL-ovima
		...
		protected void configure(HttpSecurity http) throws Exception {
			http
					...
					.authorizeRequests().antMatchers("/auth/login/**").permitAll().antMatchers("/auth/register/**").permitAll().antMatchers("/api/foo").permitAll()
